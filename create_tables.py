...
ddl_statements = [
    ...
    CREATE TABLE LYNX_PM_NOTICES (
        ...
        CONSTRAINT PK_LYNX_PM_NOTICES PRIMARY KEY (ID),
        CONSTRAINT UQ_LYNX_PM_NOTICES_NUMBER UNIQUE (NOTICE_NUMBER)
    )
    """,
    """
    CREATE TABLE LYNX_PM_OPERATIONS (
        ID                    RAW(16)      DEFAULT SYS_GUID() NOT NULL,
        ...
        UPDATED_AT            TIMESTAMP    DEFAULT SYSTIMESTAMP NOT NULL,
        IS_DELETED            NUMBER(1)    DEFAULT 0 NOT NULL,
        CONSTRAINT PK_LYNX_PM_OPERATIONS PRIMARY KEY (ID),
        CONSTRAINT FK_LYNX_PM_OPS_NOTICE FOREIGN KEY (NOTICE_ID) REFERENCES LYNX_PM_NOTICES(ID)
    )
    """,
    """
    ...
    """,
    "CREATE INDEX IDX_LYNX_PM_NOTICES_STATUS ON LYNX_PM_NOTICES(STATUS)",
    "CREATE INDEX IDX_LYNX_PM_NOTICES_EQ ON LYNX_PM_NOTICES(EQUIPMENT_CODE)",
    "CREATE INDEX IDX_LYNX_PM_OPS_NOTICE ON LYNX_PM_OPERATIONS(NOTICE_ID)",
